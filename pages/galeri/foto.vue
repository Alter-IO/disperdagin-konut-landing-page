    ...
    <div class="aio-section">
      <section id="foto">
        <div class="container">
          ...
          <div class="row">
            <div align="center">
              <button class="filter-button" @click="filter('all')" :class="{ active: currentFilter === 'all' }">All</button>
              <button v-for="data in kategori" key="data.id" class="filter-button" @click="filter(data.id)" :class="{ active: currentFilter === data.id }">{{ data.kategori }}</button>
            ...
            <div v-for="data in filteredItems" :key="data.id" v-bind:tabindex="data.id" class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter wow fadeInUp" :class="data.id_kategori_foto" data-wow-delay=".3s">
