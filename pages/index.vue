          ...
          <div class="row">
            <div class="col-md-12">
              <div class="title">
                <h2>PROFIL BIDANG</h2>
                <p>
                  Dinas Perdagangan dan Perindustrian Kabupaten Konawe Utara berdasarkan Peraturan Bupati Konawe Utara<br/>
            ...
            <div class="col-md-3 col-xs-6 col-sm-6">
              <div class="feature-block text-center">
                ...
                <p class="wow fadeInUp" data-wow-delay=".5s">
                  Bidang Perindustrian mempunyai mempunyai 3 seksi yaitu Seksi Pembinaan dan Pengembangan Industri, Seksi Produksi Monitoring dan Pelaporan, Seksi Energi dan Sumber Daya Mineral
                </p>
              </div>
            </div>
            <div class="col-md-3 col-xs-6 col-sm-6">
              <div class="feature-block text-center">
                ...
                <p class="wow fadeInUp" data-wow-delay=".5s">
                  Bidang Perdagangan mempunyai mempunyai 3 seksi yaitu Seksi Pembinaan pasar dan Distribusi, Seksi Perlindungan dan Pengawasan Perdagangan, Seksi Ketertiban, Pemeliharaan dan Pengembangan Pasar 
                </p>
              </div>
            </div>
            <div class="col-md-3 col-xs-6 col-sm-6">
              <div class="feature-block text-center">
                ...
                <p class="wow fadeInUp" data-wow-delay=".5s">
                  Bidang Pengelolaan Pasar mempunyai mempunyai 3 seksi yaitu Seksi Pendapatan / Retribusi Pasar, Seksi Sarana dan Prasarana, Seksi Pemeliharaan Kebersihan dan Keamanan Pasar
                </p>
              </div>
            </div>
            <div class="col-md-3 col-xs-6 col-sm-6">
              <div class="feature-block text-center">
                ...
                <p class="wow fadeInUp" data-wow-delay=".5s">
                  Bidang Kemetrologian mempunyai mempunyai 3 seksi yaitu Seksi Pelayanan Tera dan Tera Ulang, Seksi Bina Sumber Daya Manusia, Seksi Pengawasan
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="title">
                ...
                <p>
                  Kabupaten Konawe Utara memiliki beberapa jenis Komoditi Unggulan,komoditi ini terdiri dari Hasil Bumi, Hasil Laut dan Kerajinan.<br/>
        ...
        <div class="container">
          <div class="row">
            <div class="title">
              ...
              <p>Struktur Organisasi Dinas Perdagangan dan Perindustrian Konawe Utara Meliputi seluruh jabatan fungsional yang ada dalam dinas</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="block">
                ...
                <button class="wow fadeInUp btn btn-md aio-btn-success aio-font-weight-bold float left" data-wow-delay=".5s">Klik Disini</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="title">
                <h2>BERITA</h2>
                <p>Temukan Berita atau Pengumuman Penting dari dinas perdagangan dan Perindustrian Konawe utara
                </p>
              </div>
      ...
      <section id="contact-form">
        <div class="container">
          <div class="row">
            <div class="title">
              <h2>CONTACT US</h2>
              <p>Informasi tentang Lokasi atau Titik Dinas Perdagangan dan perindustrian dalam google maps yang dapat diakses oleh pengunjung serta sebuah kotak surat untuk mengirimkan kritik dan saran untuk menjadikan dinas perdagangan dan perindustrian konawe utara menjadi lebih baik!</p>
            </div>
            <div class="col-md-6 col">
              <!-- map -->
              <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13394.411243642062!2d122.14223910117175!3d-3.5453918186821562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2d99bb0515e73e7d%3A0x80090f1afb060961!2sBLUD%20RS%20Kabupaten%20Konawe%20Utara!5e0!3m2!1sen!2sid!4v1677343442104!5m2!1sen!2sid" width="100%" height="370" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
              <!--/map-->
